  ...
  <div class="container-lg p-responsive">
    ...
    <div class="involvement-section mb-5">
      ...
      <p class="text-center lead mb-4">
        Join other FINPLAN practitioners by becoming part of our Discourse community—a dedicated online space for collaboration, learning, and sharing.
      </p>
    ...
    <div class="involvement-section">
      ...
      <div class="github-container">
        <div class="unified-github-card text-center">
          <a href=" https://github.com/FINPLAN-Model" target="_blank" class="github-link">
            ...
            <h4 class="text-primary mt-2 mb-4">Contribute to FINPLAN on GitHub</h4>
          </a>
          
          <div class="contribution-section text-left">
            <h5>Contribute to This Website</h5>
            <p>
              Want to share your FINPLAN-related work, training, or resources? We welcome external contributions to this site!
            </p>
            <h6>How to contribute:</h6>
            <ul class="contribution-steps">
              <li>Fork the repository: <a href=" https://github.com/FINPLAN-Model " target="_https://github.com/FINPLAN-Model </a></li>
            ...
            <p class="text-muted">
              This website exists to grow a self-sustaining FINPLAN community—open to all. Let's make sure your work is visible and contributes to the global ecosystem!
            </p>
          </div>
        </div>
      </div>
